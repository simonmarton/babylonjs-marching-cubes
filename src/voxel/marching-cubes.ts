...
import { CubicArray, Triangle, TriangulationEntry } from '../models';
...
export const interpolateVectors = (...vectors: Vector3[]): Vector3 =>
  vectors
...
export const getTriangles = (
  ...
  console.log({
    edgeConfigIdx: getEdgeConfigIdx(cornerIntensities),
    edgeConfig,
  });
